...
\MADGRAPH~\cite{MadGraph} for \ac{LO} matrix element calculations; 
\POWHEG~v1.0~\cite{Powheg_0} and v2.0~\cite{Powheg_1,Powheg_2,Powheg_3} for \ac{NLO} processes including $\ttbar$ and single top; 
