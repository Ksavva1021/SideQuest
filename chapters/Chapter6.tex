...
Furthermore, LHC di-Higgs searches, sensitive to heavy Higgs bosons, can be broadly categorized into three types: non-resonant Standard Model Higgs pair production ($H_{125}H_{125}$)~\cite{CMS:2022hgz,CMS:2020tkr}, heavy resonance decays to a Higgs and another scalar ($X \to YH_{125}$)~\cite{CMS:2021yci,CMS:2023boe}, and heavy resonance decays to two Higgs bosons ($X \to H_{125}H_{125}$)~\cite{CMS:2022kdx,CMS:2021roc,CMS:2024rgy}.  
