...
\subsection{\texorpdfstring{Z $p_\text{T}$-mass reweighting}{Z pT-mass reweighting}}
...
\begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Figures/Chapter6/zpt_mvis_without.pdf}
            \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Figures/Chapter6/zpt_ptvis_without.pdf}
            \caption{}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Figures/Chapter6/zpt_mvis_with.pdf}
            \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Figures/Chapter6/zpt_ptvis_with.pdf}
            \caption{}
        \end{subfigure}
